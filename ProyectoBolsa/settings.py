"""
Django settings for ProyectoBolsa project.
...
SECRET_KEY = '4pg4!qes&@kxjiqk$6!b9h$33bsk^4!*q%3t(1s14d-*lrmh8n'
...
ROOT_URLCONF = 'ProyectoBolsa.urls'
...
WSGI_APPLICATION = 'ProyectoBolsa.wsgi.application'
...
ASGI_APPLICATION = 'ProyectoBolsa.routing.application'
